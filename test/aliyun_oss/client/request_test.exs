defmodule Aliyun.Oss.Client.RequestTest do
  ...
  describe "build_signed_headers/1" do
    test "build signed headers" do
      with_mock Config, [endpoint: fn -> @endpoint end, access_key_id: fn -> @access_key_id end, access_key_secret: fn -> @access_key_secret end] do
        headers = %{
        ...
        signed_request = Request.build_signed(%{
          verb: "PUT",
        ...
        assert %Request{
          headers: %{"Authorization" => "OSS 44CF9590006BF252F707:26NBxoKdsyly4EDv6inkoDft/yA="}
        } = signed_request
      end
    end
  end
